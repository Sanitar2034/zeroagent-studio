---
description: Code and architecture review for ZeroAgent Studio. Use for PR feedback or quality assessment — do not implement fixes unless asked.
mode: code
---
...
- [ ] $0-first: OpenRouter when keyed; Transformers.js fallback; `brainLabels` for UI
- [ ] `base: './'` consistent (`vite.config.ts`, asset paths)
